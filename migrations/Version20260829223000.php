...
final class Version20260829223000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        $this->addSql("CREATE TABLE IF NOT EXISTS invoice_task (
            ...
            CONSTRAINT fk_invoice_task_status FOREIGN KEY (status_id) REFERENCES status (id),
            CONSTRAINT fk_invoice_task_company FOREIGN KEY (company_id) REFERENCES people (id),
            CONSTRAINT fk_invoice_task_address FOREIGN KEY (address_id) REFERENCES address (id)
        ...
        $this->addSql('ALTER TABLE invoice_tax ADD CONSTRAINT fk_invoice_tax_task FOREIGN KEY (invoice_task_id) REFERENCES invoice_task (id) ON DELETE SET NULL');
    }

    public function down(Schema $schema): void
    {
        $this->addSql('ALTER TABLE invoice_tax DROP FOREIGN KEY fk_invoice_tax_task');
