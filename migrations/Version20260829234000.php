...
final class Version20260829234000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->ensureForeignKey('fk_invoice_tax_file', 'file_id', 'files', 'id');
        $this->ensureForeignKey('fk_invoice_tax_status', 'status_id', 'status', 'id');
        $this->ensureForeignKey('fk_invoice_tax_cte', 'cte_id', 'invoice_tax', 'id');
        $this->ensureForeignKey('fk_invoice_tax_issuer', 'issuer_id', 'people', 'id');
        $this->ensureForeignKey('fk_invoice_tax_address', 'address_id', 'address', 'id');
        $this->ensureForeignKey('fk_invoice_tax_company', 'company_id', 'people', 'id');
        $this->ensureForeignKey('fk_invoice_tax_client', 'client_id', 'people', 'id');
        $this->ensureForeignKey('fk_invoice_tax_provider', 'provider_id', 'people', 'id');
        $this->ensureForeignKey('fk_invoice_tax_carrier', 'carrier_id', 'people', 'id');
        $this->ensureForeignKey('fk_invoice_tax_provider_addr', 'provider_address_id', 'address', 'id');
        $this->ensureForeignKey('fk_invoice_tax_client_addr', 'client_address_id', 'address', 'id');
        $this->ensureForeignKey('fk_invoice_tax_carrier_addr', 'carrier_address_id', 'address', 'id');
    }
